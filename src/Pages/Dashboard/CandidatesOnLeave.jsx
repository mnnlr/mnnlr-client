...
import useGetAllLeaves from '../../hooks/dashboardHooks/useGetAllLeaves';
import { useEffect } from 'react';

const CandidatesOnLeave = () => {
  const navigate = useNavigate();

  const { isGetLeaves, isGetLeavesError, isGetLeavesLoading, callGetLeavesApi } = useGetAllLeaves();
      ...
      >
        <tbody> {authors.map((Datum, index) => (
          <tr key={index}>
            ...
            <td>
              <div>{Datum.function || Datum.designation}</div>
            </td>
            {Datum.status && <td>
              <span
...
export default CandidatesOnLeave;