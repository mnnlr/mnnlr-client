...
function Footer() {
  return (
    <footer style={{ borderTop: '1px solid rgb(36, 42, 86)', background: '#677D6A', paddingTop: '40px', color: '#fff', fontSize: '14px', textAlign: 'center', display: 'flex', justifyContent: 'space-around', alignItems: 'flex-start', flexWrap: 'wrap', gap: '20px', paddingBottom: '40px' }}>
